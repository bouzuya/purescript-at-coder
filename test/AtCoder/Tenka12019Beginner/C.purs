...
module Test.AtCoder.Tenka12019Beginner.C
  ( tests
  ) where

import Prelude

import AtCoder.Tenka12019Beginner.C as Solver
...
tests :: TestSuite
tests = TestUnit.suite "Tenka12019Beginner.C" do
  let dir = "test/AtCoder/Tenka12019Beginner/C"
