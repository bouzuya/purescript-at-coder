...
module Test.AtCoder.Tenka12019Beginner.B
  ( tests
  ) where

import Prelude

import AtCoder.Tenka12019Beginner.B as Solver
...
tests :: TestSuite
tests = TestUnit.suite "Tenka12019Beginner.B" do
  let dir = "test/AtCoder/Tenka12019Beginner/B"
